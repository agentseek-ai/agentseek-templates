...
const en = {
  ...
  "composer.send": "Send",
  "projection.powercontext": "PowerContext events",
  "projection.subagent": "subagent events",
  "projection.message": "messages",
  "projection.tool": "tool events",
  "projection.values": "state snapshots",
  "projection.raw": "raw events",
  "debug.toggle": "Show protocol and state details",
  ...
  "timeline.values": "values · state snapshot",
  "timeline.output": "output · final run state",
  "timeline.outputFailed": "output · failed",
  "timeline.raw": "raw · seq {sequence}",
  "timeline.namespace": "namespace:",
...
const zh: Record<MessageKey, string> = {
  ...
  "composer.send": "发送",
  "projection.powercontext": "PowerContext 事件",
  "projection.subagent": "子代理事件",
  "projection.message": "消息",
  "projection.tool": "工具事件",
  "projection.values": "状态快照",
  "projection.raw": "原始事件",
  "debug.toggle": "显示协议与状态详情",
  ...
  "timeline.message": "消息",
  "timeline.subagents": "子代理",
  "timeline.values": "values · 状态快照",
  "timeline.output": "output · 最终运行状态",
  "timeline.outputFailed": "output · 失败",
  "timeline.raw": "raw · 序号 {sequence}",
  "timeline.namespace": "命名空间：",
